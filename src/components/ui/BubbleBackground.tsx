...
export function BubbleBackground() {
  return (
    <div className="fixed inset-0 pointer-events-none z-[-1] overflow-hidden bg-[#FFFDF9]">
      ...
      <div className="absolute top-20 left-1/2 w-16 h-16 bg-blue-100 rounded-full opacity-30 animate-float" style={{ animationDelay: '2.5s' }}></div>
      <div className="absolute bottom-10 right-1/2 w-24 h-24 bg-sea-100 rounded-full opacity-20 animate-float" style={{ animationDelay: '0.8s' }}></div>
    </div>
  );
}
