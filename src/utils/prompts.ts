...
7. 해설과 피드백(previousAnswerProsCons, feedbackIfCorrect, feedbackIfWrong 등) 작성 시 반드시 "[장점]"과 "[단점]"이라는 키워드를 사용하여 장단점을 명확히 대비시켜 구체적으로 표기하세요. 모든 선택지가 정답이 될 수 있으므로, feedbackIfWrong에도 오답이라고 지적하지 말고 해당 선택지만의 장점과 단점을 객관적이고 깊이 있게 피드백해주세요.
